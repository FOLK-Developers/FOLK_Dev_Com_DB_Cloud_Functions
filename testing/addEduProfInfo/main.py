# addEduProfInfo : profile info like education details and professional details are added to db
...
def hello_world(request):
    ...
    #Getting username and profile info from front-end 
    ...
    # Add "educationDetails" and "professionalDetails" sub-coll in collection 'ProfileInfo'
    try:
        doc.set({
            u'EducationDetails':{
