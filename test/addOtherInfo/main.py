# addOtherInfo : Other info like linked profiles, skills and projects are added to db
...
def hello_world(request):
    ...
    # Add "linkedProfiles", "skills" and "projects" sub-coll in collection 'ProfileInfo'
    try:
        doc.set({
            u'LinkedProfiles':{
                u'url,':url,
                ...
                u'update_timestamp': datetime.now() #it will take time at which the doc is created
                },
